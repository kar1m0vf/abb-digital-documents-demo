...
export function showDocument(order){currentDocument=structuredClone(order);openModal('Sənədə baxış',documentHtml(currentDocument),{wide:true,footer:button('Close','close-modal','secondary')+`<div class="document-tools">${button(`${icon('download')} PDF yüklə`,'download-pdf','ghost')}${button(`${icon('printer')} Çap et`,'print','ghost')}</div>`});}
export const getCurrentDocument=()=>currentDocument;
export function finHelp(){openModal('<span class="help-dot">?</span> FIN Kod nədir?',`<p>Hər Azərbaycan vətəndaşına verilmiş 7 simvollu unikal kod (hərf + rəqəm qarışığı). Şəxsiyyət vəsiqəsinin üzündə, my.gov.az, emas.az portallarında istifadə olunur.</p><p class="fin-caption">FIN — Fərdi İdentifikasiya Nömrəsi</p><div class="fin-guide-pair"><img src="./assets/figma/fin-front.png" width="223" height="158" alt="Yeni şəxsiyyət vəsiqəsində FİN kodun yerləşməsi"><img src="./assets/figma/fin-back.png" width="223" height="158" alt="Köhnə şəxsiyyət vəsiqəsində FİN kodun yerləşməsi"></div>`);dialog.classList.add('fin-modal');}
export function phoneHelp(){openModal('Nömrəni necə yeniləyə bilərəm?',`<p>Təhlükəsizlik səbəbindən OTP təsdiqi üçün istifadə olunan mobil nömrə yalnız bank filialında, şəxsiyyət vəsiqənizi təqdim etməklə dəyişdirilə bilər. Bu, hesabınızın icazəsiz şəxslər tərəfindən ələ keçirilməsinin qarşısını alır.</p><ol class="help-list"><li>Ən yaxın ABB filialına şəxsiyyət vəsiqənizlə gedin</li><li>Əlaqə məlumatları yenilənməsi formunu doldurun</li><li>Yenilənmə təsdiqləndikdən sonra sifarişə davam edin</li></ol>`,{footer:button('Anladım','close-modal')});dialog.classList.add('phone-modal');dialog.insertAdjacentHTML('afterbegin',artwork('phone-attention.svg','phone-attention',64));}
